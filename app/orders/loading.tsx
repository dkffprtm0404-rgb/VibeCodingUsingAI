/**
 * app/orders/loading.tsx — 주문 내역 스켈레톤 (다크모드 지원)
 */

export default function OrdersLoading() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      <div className="h-8 w-32 bg-gray-100 dark:bg-gray-800 rounded-xl animate-pulse mb-8" />
        ...
        {[...Array(3)].map((_, i) => (
          <div key={i} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 space-y-4">
            <div className="flex justify-between">
              <div className="h-4 w-40 bg-gray-100 dark:bg-gray-800 rounded-full animate-pulse" />
              <div className="h-6 w-20 bg-gray-100 dark:bg-gray-800 rounded-full animate-pulse" />
            </div>
            <div className="flex gap-2">
              {[...Array(3)].map((_, j) => (
                <div key={j} className="w-14 h-14 bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse" />
              ))}
            </div>
            <div className="flex justify-between">
