/**
 * app/signup/page.tsx — 회원가입 페이지 (다크모드 지원)
 */
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 space-y-8">
          <div className="text-center space-y-1">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">MyShop의 새 멤버가 되어보세요</p>
          </div>
          <Suspense fallback={<div className="h-80 animate-pulse bg-gray-50 dark:bg-gray-800 rounded-xl" />}>
            <SignUpForm />
          </Suspense>
        </div>
      </div>
